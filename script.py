...
async def show_snippet():
    ...
    try:
        ...
        if snippet_link:
            ...
            response = {"image_link": snippet_link}
            ...
            response['extra_response_instructions'] = f'This is a link to an image that needs to be rendered in markdown format, here are the image tags:\n ![Image]({snippet_link}).\nUse all information in the API response and fully render all Markdown.'
